...
import com.jlee.leetcodesolutions.LeetCode0497;
import org.junit.Assert;
import org.junit.Test;

public class TestLeetCode0497 {
  @Test
  public void testProblemCase1() {
    LeetCode0497 solution = new LeetCode0497(new int[][] { {1,1,5,5} });
    for(int i = 0; i < 10; i++) {
  ...
  public void testProblemCase2() {
    LeetCode0497 solution = new LeetCode0497(new int[][] { {-2,-2,-1,-1},{1,0,3,0} });
    for(int i = 0; i < 10; i++) {
      int[] result = solution.pick();
