...
import com.jlee.leetcodesolutions.LeetCode0787;
import org.junit.Assert;
import org.junit.Test;

public class TestLeetCode0787 {
  @Test
  public void testProblemCase1() {
    int n = 3, src = 0, dst = 2, K = 1;
    int[][] flights = {{0,1,100},{1,2,100},{0,2,500}};
    LeetCode0787 solution = new LeetCode0787();
    Assert.assertEquals(200, solution.findCheapestPrice(n, flights, src, dst, K));
  }
  ...
  public void testProblemCase2() {
    ...
    int[][] flights = {{0,1,100},{1,2,100},{0,2,500}};
    LeetCode0787 solution = new LeetCode0787();
    Assert.assertEquals(500, solution.findCheapestPrice(n, flights, src, dst, K));
  }
  ...
  public void testNotPossible() {
    ...
    LeetCode0787 solution = new LeetCode0787();
    Assert.assertEquals(-1, solution.findCheapestPrice(n, flights, src, dst, K));
  }

  @Test
  public void testSrcDoesNotExist() {
  ...
  public void testTLE() {
    ...
    LeetCode0787 solution = new LeetCode0787();
    Assert.assertEquals(47, solution.findCheapestPrice(n, flights, src, dst, K));
  }
}
