...
public class LeetCode0822 {
   ...
   * backs are [1,2,4,1,3]. We choose the second card, which has number 2 on the
   * back, and it isn't on the front of any card, so 2 is good.
   * 
   * Note:
  ...
  public int flipgame(int[] fronts, int[] backs) {
    // If front and back are the same, then it is impossible. We will store these
    // values into the set.  Meaning any other numbers are possible.
